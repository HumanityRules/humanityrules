...
from devopshero_app.management.commands import doh_app_shell
...
class DohAppShellContainerResolutionTests(TestCase):
    ...
    def test_multi_container_template_defaults_to_alb_target_container(self) -> None:
        template = _template(
            slug="multi",
            containers=[{"name": "hermes"}, {"name": "learneo-mcp"}],
    ...
    def test_requested_template_container_resolves_to_ecs_container_name(self) -> None:
        ...
        container_name = doh_app_shell._resolve_ecs_container_name(app=app, requested_container="learneo-mcp")

        self.assertEqual(container_name, "my-app-learneo-mcp")
