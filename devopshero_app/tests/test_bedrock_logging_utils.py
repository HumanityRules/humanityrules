...
import devopshero_app.services.infra_customer.bedrock_logging_utils as bedrock_logging_utils
...
class TestEnsureInvocationLogging(SimpleTestCase):
    ...
    @patch("devopshero_app.services.infra_customer.bedrock_logging_utils.time.sleep")
