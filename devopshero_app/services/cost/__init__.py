...
Entry points (the HTTP view in ``devopshero_app/views/apps.py`` and the job worker call in here):
...
(see ``docs/app_cost_tracking_design.md``). The models live in ``devopshero_app/models.py`` with the
