...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('devopshero_app', '0040_apptemplate_prefill_name'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='app_removal_jobs', to='devopshero_app.organization')),
            ],
            options={
                'ordering': ['-created_at'],
            },
