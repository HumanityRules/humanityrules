...
Usage:
    ...
    python manage.py doh_deploy --base --account "Humanity Rules Sandbox"
    python manage.py doh_deploy --base --account "Humanity Rules Sandbox" --teardown
    python manage.py doh_deploy --base --account "Humanity Rules Sandbox" --synth-only
