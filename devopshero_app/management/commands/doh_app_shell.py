...
Usage:
    uv run manage.py doh_app_shell --account "Humanity Rules Sandbox" --app my-app-slug
    uv run manage.py doh_app_shell --account "Humanity Rules Sandbox" --env prod --app my-app-slug
    uv run manage.py doh_app_shell --account "Humanity Rules Sandbox" --app my-app-slug --container hermes
    uv run manage.py doh_app_shell --account "Humanity Rules Sandbox" --org "Humanity Rules" --app my-app-slug
