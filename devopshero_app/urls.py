...
urlpatterns = [
    ...
    path("security/permissions/<uuid:permission_request_id>/statements/", views.security_permissions_editor_statements, name="security_permissions_editor_statements"),
    path("security/permissions/<uuid:permission_request_id>/resources/", views.security_permissions_editor_resources, name="security_permissions_editor_resources"),
