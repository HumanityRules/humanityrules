...
urlpatterns = [
    ...
    path("security/permissions/<uuid:request_id>/apply/", views.security_permissions_editor_apply, name="security_permissions_editor_apply"),
    path("security/permissions/<uuid:request_id>/statements/", views.security_permissions_editor_statements, name="security_permissions_editor_statements"),
