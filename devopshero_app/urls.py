...
urlpatterns = [
    ...
    path("environments/<slug:environment_slug>/", views.environment_editor, name="environment_detail"),
    path("environments/<slug:environment_slug>/environment-section/", views.environment_editor_environment_section, name="environment_editor_environment_section"),
