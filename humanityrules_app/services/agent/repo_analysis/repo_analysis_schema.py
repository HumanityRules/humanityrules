...
class SecretsConfig(BaseModel):
    ...
    secret_path: str | None = Field(description="Secret path pattern if app uses Secrets Manager SDK (e.g., 'devopshero/{env}/{app}/secrets'). Null for env-var-based secrets.")
