...
Usage:
    uv run manage.py humr_add_shared_key --org humr
    uv run manage.py humr_add_shared_key --org "Humanity Rules" --provider openrouter
    uv run manage.py humr_add_shared_key --org humr --provider anthropic --api-key sk-ant-...

Production:
    ./prod_manage.sh humr_add_shared_key --org humr --provider openrouter --api-key sk-or-...
"""
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser) -> None:
        parser.add_argument("--org", required=True, help="Organization slug or name (e.g. humr or 'Humanity Rules')")
