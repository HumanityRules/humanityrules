...
APP_DEPLOY_CONFIGS = {
    ...
    "compass-account-api": {
        ...
        "permissions": [
            {"service": "Secrets Manager", "effect": "Allow", "access_levels": ["Read"], "resources": ["arn:aws:secretsmanager:us-east-1:111222333444:secret:humr/default/compass-account-api/*"]},
        ],
    },
    "horizon-portal": {
        "cpu": 256,
