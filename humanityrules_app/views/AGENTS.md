...
def newpage(request):
    ...
    context = get_app_shell_context(current_page="newpage")
    context["items"] = items
    return render(request, "humanityrules_app/newpage.html", context=context)
```
...
### Step 3: Create the template `templates/humanityrules_app/newpage.html`
...
### Step 4: Add the icon `templates/humanityrules_app/partials/icons/newpage.html`
...
```html
{% extends "humanityrules_app/settings/settings.html" %}
