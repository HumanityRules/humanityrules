...
def _render_environment_editor(
    ...
    return render(request=request, template_name="humanityrules_app/environments/environment_editor.html", context=context)
...
def environment_editor_environment_section(request: HttpRequest, environment_id: UUID) -> HttpResponse:
    ...
    return render(
        request=request,
        template_name="humanityrules_app/environments/_environment_editor_setup_section.html",
