 ---
  ...
  Screen: Browser opens. Dashboard loads. We see the sidebar, the org name ("Humanity Rules"), a couple of existing apps on the dashboard.
...
Scene 6: App permissions (1:50–2:10)
  ...
  Narration: "The AI analyzed the code and generated a least-privilege IAM policy. The app can read from S3 and access one DynamoDB table — nothing more. And these permissions
  went through an approval workflow before they were applied."

  ---
  Scene 7: Who can deploy where (2:10–2:25)
  ...
  Narration: "The Finance team can deploy to Finance workspaces. Contractors can view but not deploy. These rules come from group attributes and policies — not from someone
  manually granting permissions one by one."

  ---
  Scene 8: Audit trail (2:25–2:35)
