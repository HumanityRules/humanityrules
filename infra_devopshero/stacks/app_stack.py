    ...
    def __init__(
        ...
        **kwargs,
        ...
        app_secrets = {
            ...
            "HUMR_ENV_SESSION_JWT_PRIVATE_KEY": ecs.Secret.from_secrets_manager(env_sso_secret, field="HUMR_ENV_SESSION_JWT_PRIVATE_KEY"),
            "HUMR_ENV_SESSION_JWT_KID": ecs.Secret.from_secrets_manager(env_sso_secret, field="HUMR_ENV_SESSION_JWT_KID"),
